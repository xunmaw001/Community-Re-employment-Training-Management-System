...
public class PeixunxiangmuView extends PeixunxiangmuEntity implements Serializable {
	...
	public PeixunxiangmuView() {

	}

	public PeixunxiangmuView(PeixunxiangmuEntity peixunxiangmuEntity) {
		try {
			BeanUtils.copyProperties(this, peixunxiangmuEntity);
