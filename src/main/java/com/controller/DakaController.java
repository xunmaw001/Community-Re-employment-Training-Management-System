    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(daka !=null){
            ...
            BeanUtils.copyProperties( daka , view );//把实体数据重构到view中
                ...
                //级联表
                RenyuanEntity renyuan = renyuanService.selectById(daka.getRenyuanId());
                if(renyuan != null){
    ...
    */
    ...
    public R save(@RequestBody DakaEntity daka, HttpServletRequest request){
        ...
        if(false)
            ...
            daka.setRenyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<DakaEntity> queryWrapper = new EntityWrapper<DakaEntity>()
            .eq("renyuan_id", daka.getRenyuanId())
...
//                            dakaEntity.setRenyuanId(Integer.valueOf(data.get(0)));   //再就业人员 要改的
