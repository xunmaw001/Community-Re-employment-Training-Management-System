        ...
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
				...
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="再就业人员" onclick="checkRole('renyuan')">&nbsp;再就业人员
                        </label>
                    </div>
                </div>
				<div class="form-group">
				...
				<div class="form-group"><button type="button" class="btn btn-success"  style="width: 100%;background-color:var(--publicSubColor, #F37335);color: #FFFFFF;"  onclick="window.location.href='./modules/renyuan/register.jsp'">注册  再就业人员</button></div>
				<%--<div class="form-group"><button type="button" class="btn btn-success"  style="width: 100%;background-color:var(--publicSubColor, #F37335);color: #FFFFFF;"  onclick="window.location.href='./modules/laoshi/register.jsp'">注册  老师</button></div>--%>
