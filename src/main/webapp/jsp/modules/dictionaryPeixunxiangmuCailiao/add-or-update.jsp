...
<script>
    ...
    var tableName = "dictionaryPeixunxiangmuCailiao";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "peixunxiangmu_cailiao_types";
            data["dicName"] = "材料类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"peixunxiangmu_cailiao_types"}, (res) => {
                if(res.code == 0){
