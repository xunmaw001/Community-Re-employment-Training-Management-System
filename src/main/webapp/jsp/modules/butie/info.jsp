            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">补贴登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="renyuanId" name="renyuanId" v-model="ruleForm.renyuanId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="butieName" name="butieName" class="form-control"
                                               v-model="ruleForm.butieName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>补贴类型</label>
                                    <input style="width: 450px" id="butieValue" name="butieValue" class="form-control"
                                           v-model="ruleForm.butieValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.butieContent != null && ruleForm.butieContent != 'null' && ruleForm.butieContent != '') {
            var butieContentUeditor = UE.getEditor('butieContentEditor');
                butieContentUeditor.ready(function () {
                    ...
                    butieContentUeditor.setDisabled('fullscreen');
            });
        }
    }
