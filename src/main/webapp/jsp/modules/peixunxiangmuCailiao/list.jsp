...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">培训项目材料管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">培训项目材料列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">培训项目材料列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="peixunxiangmuCailiaoUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        材料名称
                                        <div class="layui-input-inline">
                                            <input type="text" id="peixunxiangmuCailiaoNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        材料类型
                                        <div class="layui-input-inline">
                                            <select name="peixunxiangmuCailiaoTypesSelectSearch"  style="width: 150px;" id="peixunxiangmuCailiaoTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //培训项目编号
            var peixunxiangmuCailiaoUuidNumberSearchInput = $('#peixunxiangmuCailiaoUuidNumberSearch');
            if( peixunxiangmuCailiaoUuidNumberSearchInput != null){
                if (peixunxiangmuCailiaoUuidNumberSearchInput.val() != null && peixunxiangmuCailiaoUuidNumberSearchInput.val() != '') {
                    searchForm.peixunxiangmuCailiaoUuidNumber = $('#peixunxiangmuCailiaoUuidNumberSearch').val();
                }
            }
     
            //材料名称
            var peixunxiangmuCailiaoNameSearchInput = $('#peixunxiangmuCailiaoNameSearch');
            if( peixunxiangmuCailiaoNameSearchInput != null){
                if (peixunxiangmuCailiaoNameSearchInput.val() != null && peixunxiangmuCailiaoNameSearchInput.val() != '') {
                    searchForm.peixunxiangmuCailiaoName = $('#peixunxiangmuCailiaoNameSearch').val();
                }
            }
     
                //材料类型
            var peixunxiangmuCailiaoTypesSelectSearchInput = document.getElementById("peixunxiangmuCailiaoTypesSelectSearch");
            if(peixunxiangmuCailiaoTypesSelectSearchInput != null){
                var peixunxiangmuCailiaoTypesIndex = peixunxiangmuCailiaoTypesSelectSearchInput.selectedIndex;
                if( peixunxiangmuCailiaoTypesIndex  != 0){
                    searchForm.peixunxiangmuCailiaoTypes= document.getElementById("peixunxiangmuCailiaoTypesSelectSearch").options[peixunxiangmuCailiaoTypesIndex].value;
                }
            }
                            getDataList();
        }
        ...
        function getDataList() {
            http("peixunxiangmuCailiao/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                peixunxiangmuCailiaoDelete: 1,
                //本表的
                peixunxiangmuCailiaoUuidNumber: searchForm.peixunxiangmuCailiaoUuidNumber,
                peixunxiangmuCailiaoName: searchForm.peixunxiangmuCailiaoName,
                peixunxiangmuCailiaoTypes: searchForm.peixunxiangmuCailiaoTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //培训项目编号
            var peixunxiangmuCailiaoUuidNumberCell = document.createElement('td');
            peixunxiangmuCailiaoUuidNumberCell.innerHTML = item.peixunxiangmuCailiaoUuidNumber;
            row.appendChild(peixunxiangmuCailiaoUuidNumberCell);


            //材料名称
            var peixunxiangmuCailiaoNameCell = document.createElement('td');
            peixunxiangmuCailiaoNameCell.innerHTML = item.peixunxiangmuCailiaoName;
            row.appendChild(peixunxiangmuCailiaoNameCell);


            //材料类型
            var peixunxiangmuCailiaoTypesCell = document.createElement('td');
            peixunxiangmuCailiaoTypesCell.innerHTML = item.peixunxiangmuCailiaoValue;
            row.appendChild(peixunxiangmuCailiaoTypesCell);


            //材料数量
            var peixunxiangmuCailiaoNumberCell = document.createElement('td');
            peixunxiangmuCailiaoNumberCell.innerHTML = item.peixunxiangmuCailiaoNumber;
            row.appendChild(peixunxiangmuCailiaoNumberCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("peixunxiangmuCailiao/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addpeixunxiangmuCailiao", "addpeixunxiangmuCailiao");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function peixunxiangmuCailiaoTypesSelectSearch() {
            var peixunxiangmuCailiaoTypesSelectSearch = document.getElementById('peixunxiangmuCailiaoTypesSelectSearch');
            if(peixunxiangmuCailiaoTypesSelectSearch != null) {
                peixunxiangmuCailiaoTypesSelectSearch.add(new Option('-请选择-',''));
                if (peixunxiangmuCailiaoTypesOptions != null && peixunxiangmuCailiaoTypesOptions.length > 0){
                    for (var i = 0; i < peixunxiangmuCailiaoTypesOptions.length; i++) {
                            peixunxiangmuCailiaoTypesSelectSearch.add(new Option(peixunxiangmuCailiaoTypesOptions[i].indexName,peixunxiangmuCailiaoTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
        ...
        //当前表的下拉框赋值
            ...
            peixunxiangmuCailiaoTypesSelectSearch();
