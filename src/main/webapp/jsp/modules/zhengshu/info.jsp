            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">证书登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="renyuanId" name="renyuanId" v-model="ruleForm.renyuanId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="zhengshuUuidNumber" name="zhengshuUuidNumber" class="form-control"
                                               v-model="ruleForm.zhengshuUuidNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>证书类型</label>
                                    <input style="width: 450px" id="zhengshuValue" name="zhengshuValue" class="form-control"
                                           v-model="ruleForm.zhengshuValue" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>证书文件</label>
                                    <img id="zhengshuPhotoImg" width="100" height="100">
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.zhengshuContent != null && ruleForm.zhengshuContent != 'null' && ruleForm.zhengshuContent != '') {
            var zhengshuContentUeditor = UE.getEditor('zhengshuContentEditor');
                zhengshuContentUeditor.ready(function () {
                    ...
                    zhengshuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
