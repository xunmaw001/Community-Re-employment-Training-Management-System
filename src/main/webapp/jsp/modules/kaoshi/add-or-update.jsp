                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="laoshiId" name="laoshiId" type="hidden">
                                    <div class="form-group col-md-6 kaoshiUuidNumberDiv">
                                        <label>考试编号</label>
                                    ...
                                    <div class="form-group col-md-6 kaoshiAddressDiv">
                                        <label>考试地点</label>
                                        <input style="width: 450px" id="kaoshiAddress" name="kaoshiAddress" class="form-control"
                                               placeholder="考试地点">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 kaoshiTypesDiv">
                                        <label>考试类型</label>
                                        <select style="width: 450px" id="kaoshiTypesSelect" name="kaoshiTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                laoshiId: "required",
                kaoshiUuidNumber: "required",
                kaoshiName: "required",
                kaoshiAddress: "required",
                kaoshiTime: "required",
            ...
            messages: {
                laoshiId: "老师不能为空",
                kaoshiUuidNumber: "考试编号不能为空",
                kaoshiName: "考试名称不能为空",
                kaoshiAddress: "考试地点不能为空",
                kaoshiTime: "考试时间不能为空",
                kaoshiTypes: "考试类型不能为空",
                kaoshiContent: "考试详情不能为空",
            }
        }).form();
    }
    ...
    function getDetails() {
        ...
        if (addkaoshi != null && addkaoshi != "" && addkaoshi != "null") {
            //注册表单验证
            $(validform());
            $("#kaoshiUuidNumber").val(new Date().getTime()+Math.ceil(Math.random()*10));//设置唯一号
