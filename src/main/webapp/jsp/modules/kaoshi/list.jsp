...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="kaoshiUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="考试编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        考试地点
                                        <div class="layui-input-inline">
                                            <input type="text" id="kaoshiAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="考试地点" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //考试编号
            var kaoshiUuidNumberSearchInput = $('#kaoshiUuidNumberSearch');
            if( kaoshiUuidNumberSearchInput != null){
                if (kaoshiUuidNumberSearchInput.val() != null && kaoshiUuidNumberSearchInput.val() != '') {
                    searchForm.kaoshiUuidNumber = $('#kaoshiUuidNumberSearch').val();
                }
            }
            ...
            //考试地点
            var kaoshiAddressSearchInput = $('#kaoshiAddressSearch');
            if( kaoshiAddressSearchInput != null){
                if (kaoshiAddressSearchInput.val() != null && kaoshiAddressSearchInput.val() != '') {
                    searchForm.kaoshiAddress = $('#kaoshiAddressSearch').val();
                }
            }
        ...
        function getDataList() {
            http("kaoshi/page", "GET", {
                ...
                kaoshiDelete: 1,
                //本表的
                kaoshiUuidNumber: searchForm.kaoshiUuidNumber,
                kaoshiName: searchForm.kaoshiName,
                kaoshiAddress: searchForm.kaoshiAddress,
        ...
        function setDataRow(item, number) {
            ...
            //考试编号
            var kaoshiUuidNumberCell = document.createElement('td');
            kaoshiUuidNumberCell.innerHTML = item.kaoshiUuidNumber;
            row.appendChild(kaoshiUuidNumberCell);
            ...
            //考试地点
            var kaoshiAddressCell = document.createElement('td');
            kaoshiAddressCell.innerHTML = item.kaoshiAddress;
            row.appendChild(kaoshiAddressCell);
