...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">培训项目管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">培训项目列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">培训项目列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("peixunxiangmu/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                peixunxiangmuDelete: 1,
                //本表的
        ...
        function setDataRow(item, number) {
            ...
            //所属培训公司
            var peixunxiangmuGongsiCell = document.createElement('td');
            peixunxiangmuGongsiCell.innerHTML = item.peixunxiangmuGongsi;
            row.appendChild(peixunxiangmuGongsiCell);


            //培训公司地址
            var peixunxiangmuGongsiAddressCell = document.createElement('td');
            peixunxiangmuGongsiAddressCell.innerHTML = item.peixunxiangmuGongsiAddress;
            row.appendChild(peixunxiangmuGongsiAddressCell);


            //培训地址
            var peixunxiangmuPeixunAddressCell = document.createElement('td');
            peixunxiangmuPeixunAddressCell.innerHTML = item.peixunxiangmuPeixunAddress;
            row.appendChild(peixunxiangmuPeixunAddressCell);
            ...
            //培训开始时间
            var peixunKaishiTimeCell = document.createElement('td');
            peixunKaishiTimeCell.innerHTML = item.peixunKaishiTime;
            row.appendChild(peixunKaishiTimeCell);


            //培训结束时间
            var peixunJieshuTimeCell = document.createElement('td');
            peixunJieshuTimeCell.innerHTML = item.peixunJieshuTime;
            row.appendChild(peixunJieshuTimeCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("peixunxiangmu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addpeixunxiangmu", "addpeixunxiangmu");
            window.location.href = "add-or-update.jsp"
        }
