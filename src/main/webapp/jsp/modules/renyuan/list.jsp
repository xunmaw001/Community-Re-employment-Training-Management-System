...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">再就业人员管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">再就业人员列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">再就业人员列表</h3>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //再就业人员身份证号
            var renyuanIdNumberCell = document.createElement('td');
            renyuanIdNumberCell.innerHTML = item.renyuanIdNumber;
            row.appendChild(renyuanIdNumberCell);
            ...
            //电子邮箱
            var renyuanEmailCell = document.createElement('td');
            renyuanEmailCell.innerHTML = item.renyuanEmail;
            row.appendChild(renyuanEmailCell);
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addrenyuan", "addrenyuan");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("renyuan/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){
                    getDataList();
