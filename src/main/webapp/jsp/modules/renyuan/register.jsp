...
<body style="background-image:url('/shequzaijiuye/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>再就业人员姓名</label>
                                    <input id="renyuanName" name="renyuanName" class="form-control"
                                           placeholder="再就业人员姓名">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>再就业人员手机号</label>
                                    <input id="renyuanPhone" name="renyuanPhone" class="form-control"
                                           onchange="renyuanPhoneChickValue(this)"  placeholder="再就业人员手机号">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>再就业人员身份证号</label>
                                    <input id="renyuanIdNumber" name="renyuanIdNumber" class="form-control"
                                ...
                                <div class="form-group col-md-12">
                                    <label>电子邮箱</label>
                                    <input id="renyuanEmail" name="renyuanEmail" class="form-control"
                                           placeholder="电子邮箱">
                                </div>
                                <div class="form-group col-md-12">
    ...
    <script>
        ...
        function submit() {
            ...
            if (validform() == true && compare() == true) {
                ...
                var urlParam;
                var successMes = '';
                httpJson("renyuan/register", "POST", data, (res) => {
                    if(res.code == 0){
